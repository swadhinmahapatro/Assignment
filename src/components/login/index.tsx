...
import AuthService from '@/interceptor/Services/AuthService';
...
const Login = () => {
  ...
  async function loginsubstrate() {
    ...
    if (window) {
      const isWeb3Injected = (await import("@polkadot/extension-dapp"))?.isWeb3Injected as any;
  ...
  const renderError = (err: string) => {
    return err ? <span className="text-red-500 font-medium size-1 text-xs">{err.slice(0, 1).toUpperCase() + err.slice(1)}</span> : null
  };
  ...
  const onSubmit = async (data: LoginData) => {
    ...
    await AuthService.login(data)
      .then((res) => {
        ...
        toast.error(err?.response?.data?.message, { id: "error" });
      })
  };
            ...
            >
              <div className="inline-block align-bottom p-0.5 rounded-lg bg-gradient-to-br from-W3G1  via-W3G2 to-W3G3 text-left overflow-hidden shadow-xl transform transition-all sm:y-8 sm:align-middle   ">
                ...
                <div className="bg-black px-4 py-5 sm:px-6 lg:px-12 rounded-md sm:p-6 lg:p-12">
                  ...
                  <button className="bg-neutral-700 flex justify-between text-white p-4 rounded-lg w-full my-8" onClick={loginsubstrate}>
                    <div className="text-lg font-semibold">
                      WalletConnect
                    </div>
                    <div>
              ...
              <div className="inline-block align-bottom p-0.5 rounded-lg bg-gradient-to-br from-W3G1  via-W3G2 to-W3G3 text-left overflow-hidden shadow-xl transform transition-all sm:align-middle   ">
                <div className="bg-black px-4 py-5 sm:px-6 lg:px-12 rounded-md sm:p-6">
                  ...
                  <div className="ml-3 text-sm">
                    ...
                    <form onSubmit={handleSubmit(onSubmit)} className="mt-5 sm:mt-6 flex flex-col justify-center">
                      <div className="mb-6">
                        <input
                          className=" bg-W3GInfoBG text-xs md:text-sm text-white  rounded-lg p-4  border border-W3GInfoBG   hover:border-neutral-600 focus:border-neutral-600  transition duration-300  outline-none w-full"
                      ...
                      <div className="mb-6">
                        <div className='relative w-full'>
                          ...
                          <button
                            ...
                            className="absolute right-3 top-1/2 -translate-y-1/2 text-neutral-400 hover:text-[#8E6CCD]"
                          >
                      ...
                      <button
                        type="submit"
                        className="inline-flex justify-center rounded-md   shadow-sm px-4 py-2 bg-gradient-to-r from-W3G1  via-W3G2 to-W3G3 text-base font-medium text-white  sm:text-sm my-3"
                      >
